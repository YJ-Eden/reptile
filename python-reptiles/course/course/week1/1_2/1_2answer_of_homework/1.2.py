...
# path = 'C:/Users/Administrator.ZX-201607191137/Desktop/1_2_homework_required/index.html'  # 这里使用了相对路径,只要你本地有这个文件就能打开

with open('C:/Users/Administrator.ZX-201607191137/Desktop/1_2_homework_required/index.html', 'r') as wb_data:  # 使用with open打开本地文件
